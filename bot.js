...
ر الادمـــنـــيــــة

**⤠ +b ⥨ لمنع الشخص اللي تمنشنه من دخول الرومات الصوتي**
**⤠ +nvb ⥨ عشان تفك البان عنه من الرومات الصوتية**
...
**⤠ add.r ⥨ انشاء رتبة مع تحديد الاسم**
**⤠ delet ⥨ حذف الـروم سواء صوتي او كتابي**
**⤠ dc ⥨ لمسح جميع الرومات**
**⤠ dr لمسح جميع الرولات**
**⤠ +bc ودكاست 
**⤠ +drole ⥨ ودكاست لرتبة معينة**
**⤠ +dretall ⥨ لحذف كل الرومات و الرولات من السيرفر**
...
**⤠ rle all <rank> ⥨ لاعطاء الجميع رتبة**
**⤠ +role botsrank> ⥨ لاعطاء البوتات رتبة** 
